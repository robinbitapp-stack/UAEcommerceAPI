...
//API
const consumerKeyWC = 'ck_46c9004d79a72dc4ec58e4306fe2635374643a36';
const consumerSercretWC = 'cs_c4c8727963b370e9ab6824e7f525b2af47effc3e';
...
app.get('/getCategoriesProduct', async (req, res) => {
  try {
    ...
    if (cachedCategoryProducts && Array.isArray(cachedCategoryProducts)) {
      ...
      await syncCategoryProducts(category);
    }
